...
module.exports.runRule = function(cdsStateInit) {
    ...
    if (topicalDiclofenacs[cdsState.drugPair.topicaldiclofenac]) {
        ...
        cdsState.ruleBranchActionType = null
        cdsState.ruleBranchActionDescription = null
        return cdsState;
    } 
    ...
    // } 
        ...
        cdsState.ruleBranchActionType = 'N/A'
        cdsState.ruleBranchActionDescription = 'N/A'
        return cdsState;
        ...
        cdsState.ruleBranchActionType = 'create'
        cdsState.ruleBranchActionDescription = 'Order for proton pump inhibitor (omeprazole 40 mg every morning)'
        return cdsState;
    }
